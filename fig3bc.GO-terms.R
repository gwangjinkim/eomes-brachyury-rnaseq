...
# ####################################################################
# # These are improved at 0420
# ####################################################################

# for all following paths this stays valid:
...
for (i in 1:1) {
  ...
  if (i %in% 1:4) {
    ...
    indirpath  <- "/home/josephus/Downloads/data_jelena/embr"
  ...
  if (i == 1) {
    dataname <- "embr-0717"
    outdirpath <- "/media/josephus/Elements/DEanalysis/embr-0717"
    metapath <- "/home/josephus/Downloads/data_jelena/embr/meta0717.txt"
  }
